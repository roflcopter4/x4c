...
#define ALWAYS_INLINE  __attribute__((__always_inline__, __gnu_inline__)) extern inline
...
#  define __always_inline extern __inline__ __attribute__((__always_inline__, __gnu_inline__))
#endif
...
#  define eprintf(...) (fprintf(stderr, "parse: " __VA_ARGS__), fflush(stderr))
#else
#  define eprintf(...) fprintf(stderr, "parse: " __VA_ARGS__)
#endif
